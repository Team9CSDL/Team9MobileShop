    ...
    if($_POST['email'] != '' && $_POST['phone'] != '' && $_POST['email'] != '' && $_POST['address'] != '' && isset($_SESSION['cart'])){
        ...
        $html = '<div style="border: 1px dotted forestgreen;">
            ...
            $html .= '<tr style="font-size: 30px; font-weight: bold; color: red;">
                ...
                <p align="center" style="font-weight: bold;">Cảm ơn bạn đã mua hàng bên Team9MobileShop</p>';
                ...
                try {
                    ...
                    $mail->Username   = 'giangveal1998@gmail.com';            // SMTP username
                    $mail->Password   = 'bshxcxeosuvejcue';                     // SMTP password
...
<div id="customer">
    ...
    <div class="row">
        ...
        <div class="by-now col-lg-6 col-md-6 col-sm-12">
            <a href="#">
                <b>Trả góp Online</b>
                <span>Vui lòng call (+84) 0326700006</span>
            </a>
        </div>
    </div>
</div>
